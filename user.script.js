// ==UserScript==
// @name         Krunker H4x RiceFieldMemes
// @version      1.8.8
// @author       Rice Field Memes
// @description  Hax for krunker 1.8.8
// @match        *://krunker.io/*
// @namespace    https://github.com/Rice-Field-Memes
        ...
        if (!window[keyMap['init']]) {
            ...
            drawVisuals = function(c) {
                ...
                for (var i = 0; i < world.players.list.length; i++) {
                    ...
                    c.fillRect(xmin - 20, ymin -10, barMaxHeight * (e.health / e.maxHealth))
